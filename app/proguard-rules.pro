...
-keep class com.mohit.emovibes.models.PersistQueue { *; }
-keep class com.mohit.emovibes.models.PersistPlayerState { *; }
-keep class com.mohit.emovibes.models.QueueData { *; }
-keep class com.mohit.emovibes.models.QueueType { *; }
-keep class com.mohit.emovibes.playback.queues.** { *; }
