...
suspend fun fetchReleaseNotesMarkdown(): String {
    return withContext(Dispatchers.IO) {
        try {
            val document =
                Jsoup.connect("https://github.com/Emomohit/EmoVibe/releases/latest").get()
            ...
            if (changelogElement != null) {
                ...
                // pero podemos obtener el texto con formato bÃ¡sico
...
// FunciÃ³n auxiliar para convertir HTML bÃ¡sico a Markdown
