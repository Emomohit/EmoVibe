...
import com.mohit.emovibes.constants.MaxImageCacheSizeKey
...
import com.mohit.emovibes.extensions.tryOrNull
import com.mohit.emovibes.ui.component.ActionPromptDialog
...
import com.mohit.emovibes.ui.player.CanvasArtworkPlaybackCache
import com.mohit.emovibes.ui.utils.backToMain
import com.mohit.emovibes.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.mohit.emovibes.utils.ArtworkStorage.clear(context)
            }
        }
    }
