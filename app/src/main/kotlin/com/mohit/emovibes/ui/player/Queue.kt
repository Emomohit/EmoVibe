...
import com.mohit.emovibes.constants.QueueEditLockKey
...
import com.mohit.emovibes.extensions.toggleRepeatMode
...
import com.mohit.emovibes.ui.component.MediaMetadataListItem
import com.mohit.emovibes.ui.menu.PlayerMenu
import com.mohit.emovibes.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.mohit.emovibes.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.mohit.emovibes.together.TogetherSessionState.Joined).role is com.mohit.emovibes.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.mohit.emovibes.together.TogetherSessionState.Joined
                                                                val isGuest =
                                                                    joined?.role is com.mohit.emovibes.together.TogetherRole.Guest
                                                                if (isGuest) {
