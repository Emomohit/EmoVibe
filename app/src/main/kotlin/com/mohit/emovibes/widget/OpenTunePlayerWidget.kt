...
import com.mohit.emovibes.widget.PlayerWidgetActions.openAppIntent
...
class EMOVibesPlayerWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(
        ...
        provideContent {
            ...
            GlanceTheme(colors = EMOVibesWidgetColors) {
...
private val EMOVibesWidgetColors =
    ColorProviders(
        light =
            lightColorScheme(
...
private fun PlayerWidgetContent(state: PlayerWidgetState, uiPrefs: WidgetUiPrefs) {
    ...
    val artist = state.artist.ifBlank { "EMOVibes" }
