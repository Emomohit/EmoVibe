...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/Emomohit/EmoVibe/refs/heads/main/assets/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to EMOVibes"
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/Emomohit/EmoVibe"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.mohit.emovibes.utils.GlobalLog.append(
