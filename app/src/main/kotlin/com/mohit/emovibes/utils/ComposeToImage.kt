...
import com.mohit.emovibes.ui.component.LyricsBackgroundType
import com.mohit.emovibes.ui.component.LyricsCardConfig
import com.mohit.emovibes.ui.component.LyricsGlassStyle
import com.mohit.emovibes.ui.component.LyricsLayoutStyle
...
object ComposeToImage {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // Helper: branding EMOVibes (igual al original)
    // ─────────────────────────────────────────────────────────────────────────
    ...
    private fun drawBranding(
        ...
        val rawLogo   = context.getDrawable(R.drawable.emovibes)?.toBitmap(logoSize, logoSize)
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/EMOVibes")
            }
